...
const processorA = () => {
  return (
    <div className="flex flex-col items-center justify-center  mx-auto md:px-1 px-3 pb-10">
    ...
    <div className="  text-center md:mt-20 md:px-10 text-3xl mt-20   2xl:px-56 font-semibold md:text-5xl lg:text-6xl 2xl:text-7xl">
    ...
    <div className=' my-10 md:my-1 h-40  md:h-[56vh] xl:h-[70vh] lg:h-[70vh] md:w-[75vw]   relative w-[90vw]  flex justify-center'>
    <video
